...
class CommunityMissionProofServiceTest {
    ...
    fun `공동 미션 인증 단계를 제출할 수 있다`() {
        ...
        `when`(communityMissionProofRepository.existsByProofRequirementIdAndUserId(11L, 1L)).thenReturn(false)
        ...
        `when`(communityMissionProofRepository.countByCommunityMissionIdAndUserId(3L, 1L)).thenReturn(1L)
