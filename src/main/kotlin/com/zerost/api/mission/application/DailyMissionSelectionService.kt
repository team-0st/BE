...
class DailyMissionSelectionService(
    ...
    private fun createSelections(selectedDate: LocalDate): DailyMissionSelections {
        ...
        return try {
            dailyMissionSelectionRepository.saveAll(selections)
