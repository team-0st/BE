...
enum class ErrorCode(
    ...
    ADMIN_ACCESS_DENIED(HttpStatus.FORBIDDEN, "ADMIN_ACCESS_DENIED", "관리자 권한이 필요한 요청입니다."),
    ...
    MISSION_REWARD_CLAIM_NOT_AVAILABLE(HttpStatus.CONFLICT, "MISSION_REWARD_CLAIM_NOT_AVAILABLE", "아직 수령할 수 있는 미션 보상이 없습니다."),
    MISSION_REWARD_ALREADY_CLAIMED(HttpStatus.CONFLICT, "MISSION_REWARD_ALREADY_CLAIMED", "이미 수령한 미션 보상입니다."),
    INVALID_DAILY_MISSION_SELECTION(HttpStatus.INTERNAL_SERVER_ERROR, "INVALID_DAILY_MISSION_SELECTION", "오늘의 미션 편성 설정이 올바르지 않습니다."),
    REWARD_NOT_FOUND(HttpStatus.NOT_FOUND, "REWARD_NOT_FOUND", "보상 정보를 찾을 수 없습니다."),
    REWARD_NOT_CLAIMABLE(HttpStatus.CONFLICT, "REWARD_NOT_CLAIMABLE", "아직 수령할 수 있는 보상이 없습니다."),
    REWARD_ALREADY_CLAIMED(HttpStatus.CONFLICT, "REWARD_ALREADY_CLAIMED", "이미 수령한 보상입니다."),
    ...
    COMMUNITY_MISSION_ONBOARDING_REQUIRED(HttpStatus.CONFLICT, "COMMUNITY_MISSION_ONBOARDING_REQUIRED", "온보딩을 완료한 뒤 공동 미션을 진행할 수 있습니다."),
    COMMUNITY_MISSION_REWARD_NOT_FOUND(HttpStatus.NOT_FOUND, "COMMUNITY_MISSION_REWARD_NOT_FOUND", "공동 미션 보상 정보를 찾을 수 없습니다."),
    COMMUNITY_MISSION_PROOF_REQUIREMENT_NOT_FOUND(HttpStatus.NOT_FOUND, "COMMUNITY_MISSION_PROOF_REQUIREMENT_NOT_FOUND", "공동 미션 인증 단계를 찾을 수 없습니다."),
    COMMUNITY_MISSION_PROOF_NOT_FOUND(HttpStatus.NOT_FOUND, "COMMUNITY_MISSION_PROOF_NOT_FOUND", "공동 미션 인증 제출 정보를 찾을 수 없습니다."),
    COMMUNITY_MISSION_PROOF_ALREADY_SUBMITTED(HttpStatus.CONFLICT, "COMMUNITY_MISSION_PROOF_ALREADY_SUBMITTED", "이미 제출한 공동 미션 인증 단계입니다."),
    COMMUNITY_MISSION_INVALID_PROOF_IMAGE_COUNT(HttpStatus.BAD_REQUEST, "COMMUNITY_MISSION_INVALID_PROOF_IMAGE_COUNT", "공동 미션 인증 이미지 수가 올바르지 않습니다."),
    COMMUNITY_MISSION_PROOFS_INCOMPLETE(HttpStatus.CONFLICT, "COMMUNITY_MISSION_PROOFS_INCOMPLETE", "아직 모든 공동 미션 인증 단계를 제출하지 않았습니다."),
    COMMUNITY_MISSION_PROOFS_NOT_APPROVED(HttpStatus.CONFLICT, "COMMUNITY_MISSION_PROOFS_NOT_APPROVED", "아직 모든 공동 미션 인증 단계가 승인되지 않았습니다."),
    INVALID_COMMUNITY_MISSION_PROOF_REVIEW_STATUS(HttpStatus.CONFLICT, "INVALID_COMMUNITY_MISSION_PROOF_REVIEW_STATUS", "검수할 수 없는 공동 미션 인증 상태입니다."),
    ...
    SOUP_REWARD_POLICY_NOT_FOUND(HttpStatus.NOT_FOUND, "SOUP_REWARD_POLICY_NOT_FOUND", "스프 보상 정책을 찾을 수 없습니다."),
    INVALID_SOUP_REWARD_POLICY(HttpStatus.INTERNAL_SERVER_ERROR, "INVALID_SOUP_REWARD_POLICY", "스프 보상 정책이 올바르지 않습니다."),
    SOUP_REROLL_POLICY_NOT_FOUND(HttpStatus.NOT_FOUND, "SOUP_REROLL_POLICY_NOT_FOUND", "스프 리롤 정책을 찾을 수 없습니다."),
    INVALID_SOUP_REROLL_POLICY(HttpStatus.INTERNAL_SERVER_ERROR, "INVALID_SOUP_REROLL_POLICY", "스프 리롤 정책이 올바르지 않습니다."),
    ...
    INVALID_WEEKLY_RECIPE_SELECTION(HttpStatus.INTERNAL_SERVER_ERROR, "INVALID_WEEKLY_RECIPE_SELECTION", "이번 주 레시피 편성 설정이 올바르지 않습니다."),
