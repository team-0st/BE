...
enum class ErrorCode(
    ...
    MISSION_COMPLETION_MODIFICATION_NOT_ALLOWED(HttpStatus.CONFLICT, "MISSION_COMPLETION_MODIFICATION_NOT_ALLOWED", "현재 상태의 미션 인증은 수정하거나 삭제할 수 없습니다."),
    ...
    COMMUNITY_MISSION_REWARD_NOT_FOUND(HttpStatus.NOT_FOUND, "COMMUNITY_MISSION_REWARD_NOT_FOUND", "공동 미션 보상 정보를 찾을 수 없습니다."),
