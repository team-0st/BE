...
@Entity
@Table(name = "soup_bonus_reward_policy_ingredients")
class SoupBonusRewardPolicyIngredient(
    ...
    @JoinColumn(name = "soup_bonus_reward_policy_id", nullable = false)
    val soupBonusRewardPolicy: SoupBonusRewardPolicy,
