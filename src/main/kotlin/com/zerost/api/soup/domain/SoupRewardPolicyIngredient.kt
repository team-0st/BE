...
@Entity
@Table(name = "soup_reward_policy_ingredients")
class SoupRewardPolicyIngredient(
    ...
    @JoinColumn(name = "soup_reward_policy_id", nullable = false)
    val soupRewardPolicy: SoupRewardPolicy,
